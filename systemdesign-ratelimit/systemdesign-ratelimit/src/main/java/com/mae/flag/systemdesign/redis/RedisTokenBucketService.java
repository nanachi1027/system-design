...
public class RedisTokenBucketService {
    ...
    /**
     * Get 1 token from bucket, if no tokens left return -1.
     */
    ...
    /**
     * Get current elected leader's name.
     */
    public String getBucketLeader() {
        return redisHandler.opsForValue().get(bucketLeader);
    }
    ...
    /**
     * No matter how many token in bucket,
     * reset token num = 0.
     */
    public void refreshToken() {
        redisHandler.opsForValue().set(bucketName, String.valueOf(0));
    }
}
